...
namespace MYTYKit
{
    public class MYTY3DAvatarExporter : EditorWindow
    {
        ...
        [MenuItem("MYTY Kit/Extensions/Export 3D Asset Metadata", false, 100)]
        ...
        [MenuItem("MYTY Kit/Extensions/Export 3D Asset Metadata", true, 100)]
        ...
        void CreateGUI()
        {
            ...
            rootVisualElement.Q<Button>().clicked += () =>
            {
                ...
                Directory.CreateDirectory(MYTYPath.MetadataPath);
                File.WriteAllText(MYTYPath.MetadataPath+"/"+filenameField.value, target.ExportToJson());
                foreach (SceneView sceneView in SceneView.sceneViews)
                {
                    sceneView.ShowNotification(new GUIContent($"Metadata is saved at {MYTYPath.MetadataPath+"/"+filenameField.value}"));
                }
            };
